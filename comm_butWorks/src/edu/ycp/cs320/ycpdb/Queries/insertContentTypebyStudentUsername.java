...
public class insertContentTypebyStudentUsername 
{
	...
	public static void main(String[] args) throws FileNotFoundException, SQLException
	{
		...
		System.out.print("Enter student contentType");
		String contentType = keyboard.nextLine();
		...
		boolean inserted = db.insertContentTypeByUsername(username, contentType);
